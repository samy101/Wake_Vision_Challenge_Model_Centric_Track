...
model_name = 'wv_k_8_c_5_80_small'
...
#
#x = keras.layers.MaxPooling2D((2,2))(x)
#x = keras.layers.Conv2D(48, (3,3), padding='same')(x)
#x = keras.layers.BatchNormalization()(x)
#x = keras.layers.ReLU()(x)
...
print("geting size")
#print("train", get_dataset_length(train_ds))
#print("va", get_dataset_length(val_ds))
#print("test", get_dataset_length(test_ds))
